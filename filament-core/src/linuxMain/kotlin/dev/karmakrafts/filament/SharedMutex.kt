...
private class LinuxSharedMutex(
    ...
    override fun lockWrite() {
        ...
        check(handle is LinuxSharedMutexHandle) { "Handle is not a SharedLinuxMutexHandle" }
...
actual fun SharedMutex(): SharedMutex =
    LinuxSharedMutex(BoxedSharedMutexHandle(LinuxSharedMutexHandle(nativeHeap.alloc<pthread_rwlock_t> {
